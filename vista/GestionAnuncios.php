...
<body>
    ...
    <section id="sectionPrincipal2"> 
        <div class="bg-light bg-opacity-50 pb-4">
            ...
            <div class="container">
                <h1 class="fw-bold text-center pt-4">Publicación de Anuncios</h1>
                    ...
                    <div class="col">
                        <div class="card border-success p-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class=" text-center"><strong>Usuario Publica:</strong> <?php echo $anuncio->getUsuario();?></p>
                                ...
                                <div class="d-flex justify-content-around">
                                    <form action="publicaAnuncio_controller.php" method="post">
                                         <input type='hidden' name='idAnuncio' value='<?php echo $anuncio->getIdAnuncio();?>'>
                                        <button type="submit" class="btn btn-outline-success"><i class="fa fa-check" aria-hidden="true"></i></button>
                                    </form>
                                    <form action="eliminaAnuncio_controller.php" method="post">
                                         <input type='hidden' name='idAnuncio' value='<?php echo $anuncio->getIdAnuncio();?>'>
